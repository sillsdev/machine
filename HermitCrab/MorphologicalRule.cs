...
namespace SIL.HermitCrab
{
    ...
    {
        private bool _traceAnalysis;
        private bool _traceSynthesis;
        ...
        public bool TraceSynthesis
        {
            get
            {
                return _traceSynthesis;
            }

            set
            {
                _traceSynthesis = value;
            }
        }
        ...
        {
            if (!_isBlockable || ws.Root.Family == null)
                return ws;
            ...
            foreach (LexEntry entry in ws.Root.Family.Entries)
            {
                ...
                if (entry != ws.Root && ws.PartOfSpeech == entry.PartOfSpeech && entry.Stratum == ws.Stratum
