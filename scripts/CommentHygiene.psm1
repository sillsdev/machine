...
.DESCRIPTION
	Classifies whole-line comments, applies the banned-content categories, the
	.editorconfig display-width limit, and the aggregate implementation-comment
	budget. comment-hygiene.ps1 supplies the file list and the diff scope; this
	module holds the rules so they can be exercised on their own.
#>
