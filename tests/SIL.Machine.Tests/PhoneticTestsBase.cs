...
public abstract class PhoneticTestsBase
{
    ...
    protected FeatureSymbol _boundary = default!;
    ...
    public virtual void FixtureSetUp()
    {
        ...
        _boundary = new FeatureSymbol("Bdry");
        _allo = new FeatureSymbol("Allo");
        _anchor = new FeatureSymbol("Anchor");

        _type = new SymbolicFeature("Type", _word, _np, _vp, _seg, _boundary, _allo, _anchor);
        ...
        _characters = new Dictionary<char, FeatureStruct>
        {
            ...
            { ' ', FeatureStruct.New(_phoneticFeatSys).Symbol(_boundary).Feature("strRep").EqualTo(" ").Value },
            { '.', FeatureStruct.New(_phoneticFeatSys).Symbol(_boundary).Feature("strRep").EqualTo(".").Value },
            { '0', FeatureStruct.New(_phoneticFeatSys).Symbol(_boundary).Feature("strRep").EqualTo("0").Value }
        };
    }
