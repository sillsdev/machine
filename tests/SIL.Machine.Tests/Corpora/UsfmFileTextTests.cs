...
namespace SIL.Machine.Corpora
{
	...
	public class UsfmFileTextTests
	{
		...
		public void GetSegments_IncludeMarkers()
		{
			...
			Assert.That(segments[0].SegmentRef, Is.EqualTo(new VerseRef("MAT 1:1", corpus.Versification)));
			Assert.That(segments[0].Segment[0], Is.EqualTo(
		...
		public void GetSegmentsSortBasedOn()
		{
			...
			Assert.That(segments[1].SegmentRef, Is.EqualTo(new VerseRef("MAT 1:3", versification)));
			...
			Assert.That(segments[10].SegmentRef, Is.EqualTo(new VerseRef("MAT 2:5", versification)));
			Assert.That(segments[10].Segment[0], Is.EqualTo("Chapter two, verse five."));

			Assert.That(segments[11].SegmentRef, Is.EqualTo(new VerseRef("MAT 2:6", versification)));
			Assert.That(segments[11].Segment[0], Is.EqualTo("Chapter two, verse six."));
		}
	}
}
