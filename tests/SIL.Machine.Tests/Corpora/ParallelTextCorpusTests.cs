	...
	public class ParallelTextCorpusTests
	{
		...
		public void GetRows_Range()
		{
			var sourceCorpus = new DictionaryTextCorpus(
				...
				{
					TextRow(1, "source segment 1 ."),
					TextRow(2, "source segment 2 . source segment 3 .", isSentenceStart: false, isInRange: true,
						isRangeStart: true),
		...
		public void GetRows_AdjacentRangesSameText()
		{
			var sourceCorpus = new DictionaryTextCorpus(
				new MemoryText("text1", new[]
				{
					TextRow(1, "source segment 1 . source segment 2 .", isSentenceStart: false, isInRange: true,
						isRangeStart: true),
					TextRow(2, isInRange: true),
		...
		public void GetGetRows_AllSourceRows()
		{
			var sourceCorpus = new DictionaryTextCorpus(
				...
				{
					TextRow(5, "source segment 5 .")
				}),
				new MemoryText("text3", new[]
				{
					TextRow(6, "source segment 6 ."),
					TextRow(7, "source segment 7 ."),
				}));
			var targetCorpus = new DictionaryTextCorpus(
				new MemoryText("text1", new[]
				{
		...
		public void GetGetRows_SameVerseRefOneToMany()
		{
			...
			Assert.That(rows[1].TargetRefs, Is.EqualTo(
				Refs(new VerseRef("MAT 1:2", versification), new VerseRef("MAT 1:3", versification))));
