...
public class ParatextProjectSettingsTests
{
    ...
    [Test]
    public void IsBookFileName_BookNumXXG_BookNum()
    {
        ParatextProjectSettings settings = CreateSettings("41");
    ...
    [Test]
    public void IsBookFileName_BookNumXXG_BookNumBookId()
    {
        ParatextProjectSettings settings = CreateSettings("41MAT");
        Assert.That(settings.IsBookFileName("PROJ100XXG.SFM", out string bookId), Is.True);
        Assert.That(bookId, Is.EqualTo("XXG"));
    }
    ...
    [Test]
    public void IsBookFileName_WrongBookPart_BookNum()
    {
        ParatextProjectSettings settings = CreateSettings("41");
    ...
    [Test]
    public void IsBookFileName_WrongBookPart_BookId()
    {
        ParatextProjectSettings settings = CreateSettings("MAT");
        Assert.That(settings.IsBookFileName("PROJ42.SFM", out _), Is.False);
    }

    [Test]
    public void IsBookFileName_WrongBookPart_BookNumBookId()
    {
        ParatextProjectSettings settings = CreateSettings("41MAT");
        Assert.That(settings.IsBookFileName("PROJMRK.SFM", out _), Is.False);
