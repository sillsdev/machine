...
public class FeatureStructTests
{
    ...
    )
    {
        ...
        var varBindings = new VariableBindings { ["var1"] = new SymbolicFeatureValue(featSys.GetSymbol("a-")) };
        Assert.That(
        ...
        varBindings = new VariableBindings { ["var1"] = new SymbolicFeatureValue(featSys.GetSymbol("a+")) };
        Assert.That(
            varResultsSelector(fs1, fs2, varBindings),
