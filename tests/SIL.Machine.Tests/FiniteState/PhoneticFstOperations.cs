...
public class PhoneticFstOperations(Dictionary<char, FeatureStruct> characters)
    : IFstOperations<AnnotatedStringData, int>
{
    private readonly Dictionary<char, FeatureStruct> _characters = characters;
