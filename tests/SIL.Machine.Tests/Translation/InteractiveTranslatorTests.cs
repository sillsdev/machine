...
public class InteractiveTranslatorTests
{
    ...
    public async Task IsSourceSegmentValid_Invalid()
    {
        ...
        env.Engine.GetWordGraphAsync(sourceSegment)
            .Returns(Task.FromResult(new WordGraph(WhitespaceTokenizer.Instance.Tokenize(sourceSegment).ToArray())));
    ...
    public async Task Approve_WholeSourceSegment()
    {
        ...
        await env.Engine.Received().TrainSegmentAsync("En el principio la Palabra ya existía .", "In the beginning");
    }
    ...
    {
        public const string SourceSegment = "En el principio la Palabra ya existía .";
