...
public class HybridTranslationEngineTests
{
    ...
    private class TestEnvironment : DisposableBase
    {
        ...
        public TestEnvironment()
        {
            ...
            IInteractiveTranslationEngine smtEngine = Substitute.For<IInteractiveTranslationEngine>();

            AddTranslation(smtEngine, "caminé a mi habitación .", "caminé to mi room .", [0, 0.5, 0, 0.5, 0.5]);
            AddTranslation(smtEngine, "hablé con recepción .", "hablé with reception .", [0, 0.5, 0.5, 0.5]);
        ...
        )
        {
            ...
            var sources = new TranslationSources[confidences.Length];
