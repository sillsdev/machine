...
public class WordGraphTests
{
    ...
    public void Optimize_RedundantArc()
    {
        ...
        Assert.That(optimizedWordGraph.Arcs, Has.Count.EqualTo(4));
    ...
    public void Optimize_PartialPhraseOverlap()
    {
        ...
        Assert.That(optimizedWordGraph.Arcs, Has.Count.EqualTo(8));
    ...
    public void Optimize_RedundantArcWithFinalState()
    {
        ...
        Assert.That(optimizedWordGraph.Arcs, Has.Count.EqualTo(5));
