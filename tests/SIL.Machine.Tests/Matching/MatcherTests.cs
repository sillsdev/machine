...
public class MatcherTests : PhoneticTestsBase
{
    ...
    public void SimplePattern()
    {
        ...
        Pattern<AnnotatedStringData, int> pattern = Pattern<AnnotatedStringData, int>
            .New()
            .Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_seg).Symbol("syl-").Value)
            .Value;
        ...
        Assert.That(matches, Has.Length.EqualTo(17));
        ...
        Assert.That(matches, Has.Length.EqualTo(13));
        ...
        sentence.Annotations.Add(0, 3, FeatureStruct.New(_wordFeatSys).Symbol(_word).Symbol("det").Value);
        sentence.Annotations.Add(4, 7, FeatureStruct.New(_wordFeatSys).Symbol(_word).Symbol("adj").Value);
        sentence.Annotations.Add(9, 14, FeatureStruct.New(_wordFeatSys).Symbol(_word).Symbol("adj").Value);
        sentence.Annotations.Add(15, 18, FeatureStruct.New(_wordFeatSys).Symbol(_word).Symbol("noun").Value);
        sentence.Annotations.Add(19, 24, FeatureStruct.New(_wordFeatSys).Symbol(_word).Symbol("verb").Value);
        sentence.Annotations.Add(25, 29, FeatureStruct.New(_wordFeatSys).Symbol(_word).Symbol("adv").Value);
        sentence.Annotations.Add(0, 18, FeatureStruct.New().Symbol(_np).Value);
        sentence.Annotations.Add(19, 29, FeatureStruct.New().Symbol(_vp).Value);
        ...
        Assert.That(matches, Has.Length.EqualTo(4));
        ...
        matches = matcher.Matches(sentence, 7).ToArray();
        Assert.That(matches, Has.Length.EqualTo(3));
    ...
    public void AlternationPattern()
    {
        ...
        Pattern<AnnotatedStringData, int> pattern = Pattern<AnnotatedStringData, int>
            .New()
            .Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_boundary).Feature("strRep").EqualTo(" ").Value)
            .Or.Annotation(
                FeatureStruct.New(_phoneticFeatSys).Symbol(_seg).Symbol("son+").Symbol(_seg).Symbol("syl-").Value
            )
            .Value;
        ...
        Match<AnnotatedStringData, int>[] matches = matcher.Matches(sentence).ToArray();
        Assert.That(matches, Has.Length.EqualTo(16));
        ...
        pattern = Pattern<AnnotatedStringData, int>
            .New()
            .Annotation(FeatureStruct.New(_wordFeatSys).Symbol(_word).Symbol("det").Value)
            .Or.Annotation(FeatureStruct.New(_wordFeatSys).Symbol(_word).Symbol("adj").Value)
            .Or.Annotation(FeatureStruct.New(_wordFeatSys).Symbol(_word).Symbol("noun").Value)
            .Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_boundary).Feature("strRep").EqualTo(" ").Value)
            .Annotation(FeatureStruct.New(_wordFeatSys).Symbol(_word).Symbol("det").Value)
            .Or.Annotation(FeatureStruct.New(_wordFeatSys).Symbol(_word).Symbol("adj").Value)
            .Or.Annotation(FeatureStruct.New(_wordFeatSys).Symbol(_word).Symbol("noun").Value)
    ...
    public void OptionalPattern()
    {
        ...
        Pattern<AnnotatedStringData, int> pattern = Pattern<AnnotatedStringData, int>
            ...
            .Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_seg).Symbol("syl-").Value)
            .Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_seg).Symbol("syl-").Value)
            .Optional.Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_seg).Symbol("syl+").Value)
            .Value;
        ...
        matches = matcher.AllMatches(sentence).ToArray();
        Assert.That(matches, Has.Length.EqualTo(6));
        Assert.That(matches[0].Range, Is.EqualTo(Range<int>.Create(0, 3)));
        ...
        pattern = Pattern<AnnotatedStringData, int>
            ...
            .Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_boundary).Feature("strRep").EqualTo(" ").Value)
            .Group(g =>
                g.Annotation(FeatureStruct.New(_wordFeatSys).Symbol(_word).Symbol("adj").Value)
                    .Annotation(
                        FeatureStruct.New(_phoneticFeatSys).Symbol(_boundary).Feature("strRep").EqualTo(",").Value
                    )
                    .Optional.Annotation(
                        FeatureStruct.New(_phoneticFeatSys).Symbol(_boundary).Feature("strRep").EqualTo(" ").Value
                    )
            )
            .Optional.Annotation(FeatureStruct.New(_wordFeatSys).Symbol(_word).Symbol("adj").Value)
            .Value;
        ...
        pattern = Pattern<AnnotatedStringData, int>
            ...
            .LazyOptional.Annotation(FeatureStruct.New(_wordFeatSys).Symbol(_word).Symbol("adj").Value)
            .Value;
    ...
    public void ZeroOrMorePattern()
    {
        ...
        Pattern<AnnotatedStringData, int> pattern = Pattern<AnnotatedStringData, int>
            .New()
            .Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_seg).Symbol("syl-").Value)
            .ZeroOrMore.Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_seg).Symbol("syl+").Value)
            .Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_seg).Symbol("syl-").Value)
            .ZeroOrMore.Value;
        ...
        matches = matcher.AllMatches(sentence).ToArray();
        Assert.That(matches, Has.Length.EqualTo(30));
        Assert.That(matches[0].Range, Is.EqualTo(Range<int>.Create(0, 3)));
        Assert.That(matches[1].Range, Is.EqualTo(Range<int>.Create(1, 3)));
        ...
        matches = matcher.AllMatches(sentence, 7).ToArray();
        Assert.That(matches, Has.Length.EqualTo(24));
        Assert.That(matches[0].Range, Is.EqualTo(Range<int>.Create(9, 14)));
    ...
    public void OneOrMorePattern()
    {
        ...
        Pattern<AnnotatedStringData, int> pattern = Pattern<AnnotatedStringData, int>
            .New()
            .Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_seg).Symbol("syl-").Value)
            .OneOrMore.Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_seg).Symbol("syl+").Value)
            .Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_seg).Symbol("syl-").Value)
            .OneOrMore.Value;
        ...
        matches = matcher.AllMatches(sentence).ToArray();
        Assert.That(matches, Has.Length.EqualTo(7));
        Assert.That(matches[0].Range, Is.EqualTo(Range<int>.Create(15, 18)));
        Assert.That(matches[1].Range, Is.EqualTo(Range<int>.Create(19, 24)));
    ...
    public void RangePattern()
    {
        ...
        Pattern<AnnotatedStringData, int> pattern = Pattern<AnnotatedStringData, int>
            .New()
            .Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_seg).Value)
            .Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_seg).Value)
            .Range(0, 2)
            .Value;
        ...
        Match<AnnotatedStringData, int>[] matches = matcher.Matches(sentence).ToArray();
        Assert.That(matches, Has.Length.EqualTo(9));
        Assert.That(matches[0].Range, Is.EqualTo(Range<int>.Create(0, 3)));
        ...
        matches = matcher.AllMatches(sentence).ToArray();
        Assert.That(matches, Has.Length.EqualTo(51));
        Assert.That(matches[0].Range, Is.EqualTo(Range<int>.Create(0, 3)));
        ...
        matches = matcher.AllMatches(sentence, 7).ToArray();
        Assert.That(matches, Has.Length.EqualTo(39));
        Assert.That(matches[0].Range, Is.EqualTo(Range<int>.Create(9, 12)));
        Assert.That(matches[1].Range, Is.EqualTo(Range<int>.Create(9, 11)));
        ...
        matches = matcher.AllMatches(sentence).ToArray();
        Assert.That(matches, Has.Length.EqualTo(33));
        Assert.That(matches[0].Range, Is.EqualTo(Range<int>.Create(0, 3)));
        Assert.That(matches[1].Range, Is.EqualTo(Range<int>.Create(0, 2)));
        ...
        matches = matcher.AllMatches(sentence, 7).ToArray();
        Assert.That(matches, Has.Length.EqualTo(27));
        Assert.That(matches[0].Range, Is.EqualTo(Range<int>.Create(9, 13)));
    ...
    public void CapturingGroupPattern()
    {
        ...
        Pattern<AnnotatedStringData, int> pattern = Pattern<AnnotatedStringData, int>
            ...
            .Group(
                "onset",
                onset =>
                    onset.Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_seg).Symbol("syl-").Value).ZeroOrMore
            )
            .Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_seg).Symbol("syl+").Value)
            .Group(
                "coda",
                coda =>
                    coda.Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_seg).Symbol("syl-").Value).ZeroOrMore
            )
            .Value;
        ...
        pattern = Pattern<AnnotatedStringData, int>
            ...
            .Group(
                ...
                np =>
                    np.Group(det =>
                        det.Annotation(FeatureStruct.New(_wordFeatSys).Symbol(_word).Symbol("det").Value)
                            .Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_boundary).Value)
                            .OneOrMore
                    )
                        .Optional.Group(adj =>
                            adj.Annotation(FeatureStruct.New(_wordFeatSys).Symbol(_word).Symbol("adj").Value)
                                .Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_boundary).Value)
                                .OneOrMore
                        )
                        .ZeroOrMore.Group(
                            "headNoun",
                            headNoun =>
                                headNoun.Annotation(FeatureStruct.New(_wordFeatSys).Symbol(_word).Symbol("noun").Value)
                        )
            )
            .Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_boundary).Value)
            .OneOrMore.Group(
                ...
                vp =>
                    vp.Group(
                            "headVerb",
                            headVerb =>
                                headVerb.Annotation(FeatureStruct.New(_wordFeatSys).Symbol(_word).Symbol("verb").Value)
                        )
                        .Group(adv =>
                            adv.Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_boundary).Value)
                                .OneOrMore.Annotation(FeatureStruct.New(_wordFeatSys).Symbol(_word).Symbol("adv").Value)
                        )
                        .ZeroOrMore
            )
            .Value;
        ...
        matches = matcher.AllMatches(sentence).ToArray();
        Assert.That(matches, Has.Length.EqualTo(8));
    ...
    public void Subpattern()
    {
        ...
        Pattern<AnnotatedStringData, int> pattern = Pattern<AnnotatedStringData, int>
            ...
            .Subpattern(
                ...
                unvoiceInitial =>
                    unvoiceInitial
                        .Annotation(
                            FeatureStruct.New(_phoneticFeatSys).Symbol(_seg).Symbol("voice-").Symbol("son-").Value
                        )
                        .Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_seg).Symbol("syl-").Value)
                        .ZeroOrMore.Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_seg).Symbol("syl+").Value)
            )
            .Subpattern(
                "word",
                word =>
                    word.Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_seg).Symbol("syl-").Value)
                        .ZeroOrMore.Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_seg).Symbol("syl+").Value)
                        .Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_seg).Symbol("syl-").Value)
                        .ZeroOrMore
            )
        ...
        matches = matcher.AllMatches(sentence).ToArray();
        Assert.That(matches, Has.Length.EqualTo(32));
        Assert.That(matches[0].Range, Is.EqualTo(Range<int>.Create(0, 3)));
        Assert.That(matches[0].PatternPath[0], Is.EqualTo("unvoiceInitial"));
        Assert.That(matches[1].Range, Is.EqualTo(Range<int>.Create(0, 3)));
        Assert.That(matches[1].PatternPath[0], Is.EqualTo("word"));
    ...
    public void MatcherSettings()
    {
        ...
        Pattern<AnnotatedStringData, int> pattern = Pattern<AnnotatedStringData, int>
            ...
            .Group(
                "NP",
                np =>
                    np.Annotation(FeatureStruct.New(_wordFeatSys).Symbol(_word).Symbol("det").Value)
                        .Optional.Annotation(FeatureStruct.New(_wordFeatSys).Symbol(_word).Symbol("adj").Value)
                        .ZeroOrMore.Group(
                            "headNoun",
                            headNoun =>
            ...
            .Group(
                ...
                vp =>
                    vp.Group(
                        ...
                        .Annotation(FeatureStruct.New(_wordFeatSys).Symbol(_word).Symbol("adv").Value)
                        .ZeroOrMore
            )
            .Value;
        ...
        matcher = new Matcher<AnnotatedStringData, int>(
            pattern,
            new MatcherSettings<int> { Filter = ann => ((FeatureSymbol)ann.FeatureStruct.GetValue(_type)) == _word }
        );
        Match<AnnotatedStringData, int> match = matcher.Match(sentence);
        Assert.IsTrue(match.Success);
        Assert.That(match.Range, Is.EqualTo(Range<int>.Create(0, 29)));
        ...
        matcher = new Matcher<AnnotatedStringData, int>(pattern, new MatcherSettings<int> { Nondeterministic = true });
        match = matcher.Match(sentence);
        Assert.IsTrue(match.Success);
        Assert.That(match.Range, Is.EqualTo(Range<int>.Create(0, 29)));
        Assert.IsTrue(match.GroupCaptures["NP"].Success);
        ...
        pattern = Pattern<AnnotatedStringData, int>
            ...
            .Or.Group(g =>
                g.Annotation(FeatureStruct.New(_wordFeatSys).Symbol(_word).Symbol("adj").Value)
                    .Annotation(FeatureStruct.New(_wordFeatSys).Symbol(_word).Symbol("noun").Value)
                    .Annotation(FeatureStruct.New(_wordFeatSys).Symbol(_word).Symbol("verb").Value)
                    .Annotation(FeatureStruct.New(_wordFeatSys).Symbol(_word).Symbol("adv").Value)
            )
            .Value;
        ...
        matcher = new Matcher<AnnotatedStringData, int>(
            ...
            {
                Filter = ann => ((FeatureSymbol)ann.FeatureStruct.GetValue(_type)) == _word,
        ...
        pattern = Pattern<AnnotatedStringData, int>
            .New()
            .Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_boundary).Feature("strRep").EqualTo(" ").Value)
            .Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_seg).Symbol("nas+").Value)
            .Value;
    ...
    public void NondeterministicPattern()
    {
        ...
        word.Annotations.Add(0, 1, FeatureStruct.New(_phoneticFeatSys).Feature("strRep").EqualTo("t").Value);
        word.Annotations.Add(1, 2, FeatureStruct.New(_phoneticFeatSys).Feature("strRep").EqualTo("e").Value);
        word.Annotations.Add(2, 3, FeatureStruct.New(_phoneticFeatSys).Feature("strRep").EqualTo("s").Value);
        word.Annotations.Add(3, 4, FeatureStruct.New(_phoneticFeatSys).Feature("strRep").EqualTo("t").Value);
        ...
        pattern = Pattern<AnnotatedStringData, int>
            .New()
            .Group("first", g1 => g1.Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_seg).Symbol("syl+").Value))
            .Group(
                "second",
                g2 => g2.Group("third", g3 => g3.Annotation(FeatureStruct.New().Symbol(_seg).Value).Optional).ZeroOrMore
            )
            .Value;
        ...
        pattern = Pattern<AnnotatedStringData, int>
            .New()
            .Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_seg).Symbol("syl+").Value)
            .Group("first", g => g.Annotation(FeatureStruct.New().Symbol(_seg).Value).ZeroOrMore)
            .Value;
    ...
    public void DiscontiguousAnnotation()
    {
        Pattern<AnnotatedStringData, int> pattern = Pattern<AnnotatedStringData, int>
            ...
            .Group("second", second => second.Annotation(FeatureStruct.New().Symbol(_seg).Value).OneOrMore)
            .Value;
        ...
        var allo1 = new Annotation<int>(word.Range, FeatureStruct.New().Symbol(_allo).Value);
        ...
        var allo2 = new Annotation<int>(Range<int>.Create(2, 6), FeatureStruct.New().Symbol(_allo).Value);
    ...
    public void OptionalAnnotation()
    {
        Pattern<AnnotatedStringData, int> pattern = Pattern<AnnotatedStringData, int>
            .New()
            .Annotation(FeatureStruct.New().Symbol(_seg).Value)
            .OneOrMore.Value;
        ...
        pattern = Pattern<AnnotatedStringData, int>
            .New()
            .Group("first", g1 => g1.Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_seg).Symbol("syl+").Value))
            .Group("second", g2 => g2.Annotation(FeatureStruct.New().Symbol(_seg).Value).OneOrMore)
            .Value;
