...
public class MatcherTests : PhoneticTestsBase
{
    ...
    public void AlternationPattern()
    {
        ...
        Pattern<AnnotatedStringData, int> pattern = Pattern<AnnotatedStringData, int>
            .New()
            .Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_bdry).Feature("strRep").EqualTo(" ").Value)
            .Or.Annotation(
                ...
                np =>
                    np.Group(det =>
                        det.Annotation(FeatureStruct.New(_wordFeatSys).Symbol(_word).Symbol("det").Value)
                            .Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_bdry).Value)
                            .OneOrMore
                    )
                        .Optional.Group(adj =>
            ...
            .OneOrMore.Group(
                ...
                vp =>
                    vp.Group(
                        ...
                        .Group(adv =>
                            adv.Annotation(FeatureStruct.New(_phoneticFeatSys).Symbol(_bdry).Value)
    ...
    public void DiscontiguousAnnotation()
    {
        ...
        Annotation<int> allo1 = new Annotation<int>(word.Range, FeatureStruct.New().Symbol(_allo).Value);
        ...
        Annotation<int> allo2 = new Annotation<int>(Range<int>.Create(2, 6), FeatureStruct.New().Symbol(_allo).Value);
