...
public class AnnotationTests
{
    ...
    public void Add()
    {
        ...
        Assert.That(annList, Has.Count.EqualTo(1));
        Assert.That(annList.First(), Is.SameAs(a));
        Assert.That(a.Children, Has.Count.EqualTo(4));
        // add contained annotation
        a = new Annotation<int>(Range<int>.Create(9, 10), FeatureStruct.New().Value);
        annList.Add(a);
        Assert.That(annList, Has.Count.EqualTo(1));
        Assert.That(annList.First.Children, Has.Count.EqualTo(5));
        ...
        Assert.That(a.Children, Has.Count.EqualTo(2));
        annList.Add(a);
        Assert.That(annList, Has.Count.EqualTo(3));
        Assert.That(annList.ElementAt(1), Is.SameAs(a));
        Assert.That(a.Children, Has.Count.EqualTo(2));
        Assert.That(a.Children.First.Children, Has.Count.EqualTo(2));
        Assert.That(a.Children.Last.Children, Has.Count.EqualTo(2));
    }
    ...
    public void Remove()
    {
        var annList = new AnnotationList<int>
        {
            { 0, 1, FeatureStruct.New().Value },
            { 9, 10, FeatureStruct.New().Value },
            { 24, 25, FeatureStruct.New().Value },
            { 49, 50, FeatureStruct.New().Value },
            { 99, 100, FeatureStruct.New().Value }
        };
    ...
    public void Find()
    {
        var annList = new AnnotationList<int>
        {
            { 1, 2, FeatureStruct.New().Value },
            { 9, 10, FeatureStruct.New().Value },
            { 24, 25, FeatureStruct.New().Value },
            { 49, 50, FeatureStruct.New().Value },
            { 99, 100, FeatureStruct.New().Value },
            { 99, 100, FeatureStruct.New().Value },
            { new Annotation<int>(Range<int>.Create(20, 70), FeatureStruct.New().Value), false }
        };
    ...
    public void GetNodes()
    {
        ...
        Assert.That(anns, Has.Length.EqualTo(3));
        ...
        Assert.That(anns, Has.Length.EqualTo(1));
        Assert.That(anns[0], Is.EqualTo(annList.First.Next));

        anns = annList.GetNodes(0, 200).ToArray();
        Assert.That(anns, Has.Length.EqualTo(6));
    }
    ...
    public void FindDepthFirst()
    {
        var annList = new AnnotationList<int>
        {
            ...
            { 9, 10, FeatureStruct.New().Value },
            { 49, 50, FeatureStruct.New().Value },
            { 69, 70, FeatureStruct.New().Value },
            { 99, 100, FeatureStruct.New().Value },
            { 1, 49, FeatureStruct.New().Value },
            { 51, 100, FeatureStruct.New().Value }
        };
