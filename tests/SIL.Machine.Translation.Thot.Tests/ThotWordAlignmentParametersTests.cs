...
public class ThotWordAlignmentParametersTests
{
    ...
    {
        var parameters = new ThotWordAlignmentParameters { FastAlignIterationCount = 2 };
    ...
    {
        var parameters = new ThotWordAlignmentParameters { Ibm1IterationCount = 2 };
    ...
    {
        var parameters = new ThotWordAlignmentParameters { Ibm2IterationCount = 2 };
    ...
    {
        var parameters = new ThotWordAlignmentParameters { HmmIterationCount = 2 };
    ...
    {
        var parameters = new ThotWordAlignmentParameters { Ibm3IterationCount = 2 };
    ...
    {
        var parameters = new ThotWordAlignmentParameters { Ibm4IterationCount = 2 };
