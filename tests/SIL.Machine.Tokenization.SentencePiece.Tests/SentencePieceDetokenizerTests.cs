...
namespace SIL.Machine.Tokenization.SentencePiece
{
	...
	public class SentencePieceDetokenizerTests
	{
		...
		public void Detokenize()
		{
			...
			string sentence = detokenizer.Detokenize("▁In ▁particular , ▁the ▁actress es ▁play ▁a ▁major ▁role ▁in ▁the ▁sometimes ▁rather ▁dubious ▁staging .".Split());
			Assert.That(sentence, Is.EqualTo("In particular, the actresses play a major role in the sometimes rather dubious staging."));
		}
