...
{
    protected TraceManager _ttraceManager = default!;
    ...
    {
        _ttraceManager = new TraceManager();
...
#pragma warning disable CA1720 // Identifier contains type name - Don't touch the legacy code
