...
namespace SIL.Machine.Morphology.HermitCrab.MorphologicalRules
{
    public class AffixProcessRuleTests : HermitCrabTestBase
    {
        ...
        public void SuffixRules()
        {
            ...
            {
                Name = "rule1",
                Lhs = Pattern<Word, ShapeNode>.New().Annotation(Char(Table3, "t")).Value
            };
            prule1.Subrules.Add(
                new RewriteSubrule
                {
            ...
            Assert.That(
                morpher.GenerateWords(Entries["32"], new Morpheme[] { sSuffix }, new FeatureStruct()),
                Is.EquivalentTo(new[] { "sagz" })
            );
            Assert.That(
                morpher.GenerateWords(Entries["32"], new Morpheme[] { edSuffix }, new FeatureStruct()),
                Is.EquivalentTo(new[] { "sagd" })
            );
            Assert.That(
                morpher.GenerateWords(Entries["33"], new Morpheme[] { sSuffix }, new FeatureStruct()),
                Is.EquivalentTo(new[] { "sasɯz" })
            );
            Assert.That(
                morpher.GenerateWords(Entries["33"], new Morpheme[] { edSuffix }, new FeatureStruct()),
                Is.EquivalentTo(new[] { "sast" })
            );
            Assert.That(
                morpher.GenerateWords(Entries["34"], new Morpheme[] { edSuffix }, new FeatureStruct()),
        ...
        public void PrefixRules()
        {
            ...
            sPrefix.Allomorphs.Add(
                new AffixProcessAllomorph
                {
                    Lhs =
                    {
                        Pattern<Word, ShapeNode>.New("1").Annotation(voicelessCons).Annotation(any).OneOrMore.Value
                    },
            ...
            aspiration.Subrules.Add(
                new RewriteSubrule { Rhs = Pattern<Word, ShapeNode>.New().Annotation(unasp).Value, }
            );
                ...
                new AffixProcessAllomorph
                {
                    ...
                    Rhs =
                    {
                        new InsertSimpleContext(
                            FeatureStruct
                                .New(Language.PhonologicalFeatureSystem, alvStop)
                                .Feature("vd")
                                .EqualToVariable("a")
                                .Value
                        ),
                ...
                new AffixProcessAllomorph
                {
                    Lhs =
                    {
                        ...
                        Pattern<Word, ShapeNode>
                            ...
                            .Annotation(
                                FeatureStruct
                                    .New(Language.PhonologicalFeatureSystem, lowVowel)
                                    .Feature("ATR")
                                    .EqualToVariable("a")
                                    .Value
                            )
        ...
        public void InfixRules()
        {
            ...
            perfPass.Allomorphs.Add(
                new AffixProcessAllomorph
                {
                    ...
                    {
                        new CopyFromInput("1"),
                        new InsertSegments(Table3, "u"),
                        new CopyFromInput("2"),
                        new InsertSegments(Table3, "i"),
                        new CopyFromInput("3")
                    }
                }
            );
        ...
        public void SimulfixRules()
        {
            ...
            simulfix.RequiredSyntacticFeatureStruct = FeatureStruct
                .New(Language.SyntacticFeatureSystem)
                .Symbol("N")
                .Value;
            simulfix.Allomorphs.Clear();
        ...
        public void ReduplicationRules()
        {
            ...
            {
                Name = "voicing",
                Lhs = Pattern<Word, ShapeNode>.New().Annotation(Char(Table1, "s")).Value
            };
            ...
            {
                Name = "g_delete",
                Lhs = Pattern<Word, ShapeNode>.New().Annotation(Char(Table1, "g")).Value
            };
