...
/// <summary>
/// FstVerification.Compare is a manual gap-inspection tool: it measures FST-vs-search analysis-set
/// divergence over a corpus, reporting missing analyses (fast-path gaps) and extra analyses (which
/// would be a soundness bug) at once. Diagnostic only — nothing gates behavior on its result.
/// </summary>
public class FstVerificationTests : HermitCrabTestBase
{
    ...
    [Test]
    public void Compare_FstVsSearch_MatchesOnConcatenativeCorpus()
    {
    ...
    public void Compare_DetectsMissingAnalyses_NotVacuous()
    {
        ...
        Assert.That(comparison.MatchesReferenceExactly, Is.False);
