...
namespace SIL.Machine.Morphology.HermitCrab.PhonologicalRules
{
    public class RewriteRuleTests : HermitCrabTestBase
    {
        ...
        public void SimpleRules()
        {
            ...
            {
                Name = "rule1",
                Lhs = Pattern<Word, ShapeNode>.New().Annotation(Char(Table1, "t")).Value
            };
            ...
            {
                Name = "rule2",
                Lhs = Pattern<Word, ShapeNode>.New().Annotation(Char(Table3, "p")).Value
            };
            ...
            rule3.Subrules.Add(
                new RewriteSubrule
                {
                    ...
                    LeftEnvironment = Pattern<Word, ShapeNode>
                        ...
                        .Annotation(cons)
                        .Optional.Annotation(Char(Table3, "+"))
                        .Annotation(cons)
        ...
        public void BoundaryRules()
        {
            ...
            rule2.Subrules.Add(
                new RewriteSubrule
                {
                    ...
                    RightEnvironment = Pattern<Word, ShapeNode>
                        .New()
                        .Group(group => group.Annotation(Char(Table3, "+")).Annotation(Char(Table3, "b")))
                        .Value
                }
            );
            Morphophonemic.PhonologicalRules.Add(rule2);
        ...
        public void CommonFeatureRules()
        {
            ...
            {
                Name = "rule1",
                Lhs = Pattern<Word, ShapeNode>.New().Annotation(Char(Table1, "p")).Value
            };
            Allophonic.PhonologicalRules.Add(rule1);
            rule1.Subrules.Add(
                new RewriteSubrule
        ...
        public void EpenthesisRules()
        {
            ...
            {
                Name = "rule1",
                Lhs = Pattern<Word, ShapeNode>.New().Annotation(vowel).Value
            };
            Allophonic.PhonologicalRules.Add(rule1);
            rule1.Subrules.Add(
                new RewriteSubrule
