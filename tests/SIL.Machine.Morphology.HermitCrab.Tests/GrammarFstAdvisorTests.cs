...
public class GrammarFstAdvisorTests : HermitCrabTestBase
{
    ...
    public void Analyze_ConcatenativeGrammar_Tier1NoEscapes()
    {
        ...
        splitSuffix.Allomorphs.Add(
            new AffixProcessAllomorph
            {
                Lhs =
                {
                    Pattern<Word, int>.New("1").Annotation(any).Value,
    ...
    public void Analyze_BoundedReduplicant_IsRegular()
    {
        ...
        redup.Allomorphs.Add(
            new AffixProcessAllomorph
            {
                Lhs = { Pattern<Word, int>.New("1").Annotation(any).Value },
    ...
    public void Analyze_HarmonyRewrite_StaysEscapeButIsRegular()
    {
        ...
        var harmony = new RewriteRule { Name = "harmony", Lhs = Pattern<Word, int>.New().Annotation(any).Value };
        harmony.Subrules.Add(
            new RewriteSubrule
            {
                Rhs = Pattern<Word, int>.New().Annotation(any).Value,
                LeftEnvironment = Pattern<Word, int>.New().Annotation(any).OneOrMore.Value,
            }
        );
    ...
    public void Analyze_ReduplicationWithLaterPhonology_IsOpaque()
    {
        ...
        var rule = new RewriteRule { Name = "t_rule", Lhs = Pattern<Word, int>.New().Annotation(any).Value };
