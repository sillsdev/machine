...
public class NmtEngineRuntime : AsyncDisposableBase, ITranslationEngineRuntime
{
	...
	public NmtEngineRuntime(IRepository<Build> builds, IBackgroundJobClient jobClient,
		IDistributedReaderWriterLockFactory lockFactory, string engineId)
	{
		_engineId = engineId;
		_builds = builds;
	...
	public Task TrainSegmentPairAsync(IReadOnlyList<string> sourceSegment, IReadOnlyList<string> targetSegment,
		bool sentenceStart)
	{
		CheckDisposed();
