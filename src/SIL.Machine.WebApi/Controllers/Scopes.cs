...
public static class Scopes
{
	...
	{
		CreateTranslationEngines, ReadTranslationEngines, UpdateTranslationEngines, DeleteTranslationEngines,
		CreateCorpora, ReadCorpora, UpdateCorpora, DeleteCorpora,
