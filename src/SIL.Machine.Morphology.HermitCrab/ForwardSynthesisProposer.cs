...
namespace SIL.Machine.Morphology.HermitCrab
{
    ...
    {
        private readonly Dictionary<string, List<WordAnalysis>> _table = new Dictionary<string, List<WordAnalysis>>(
        ...
        public ForwardSynthesisProposer(Language language, Morpher morpher, int maxAffixes = 2, int budget = 500_000)
        {
            ...
            // genuine coverage; plain prefix/suffix are already covered by the FST. Verify still
            // confirms every candidate, so a false claim here costs coverage, never soundness.
            _coveredOps = covered
                .Where(o =>
