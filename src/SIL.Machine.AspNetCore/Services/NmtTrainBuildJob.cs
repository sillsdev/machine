...
public class NmtTrainBuildJob : HangfireBuildJob
{
    ...
    public override Task RunAsync(string engineId, string buildId, CancellationToken cancellationToken)
    {
        return base.RunAsync(engineId, buildId, cancellationToken);
    }
