...
namespace SIL.Machine.Web
{
	public class StandardHttpClient : IHttpClient
	{
		...
		public async Task<HttpResponse> SendAsync(HttpRequestMethod method, string url, string body = null, string contentType = null)
		{
			...
			if (body != null)
				request.Content = contentType == null ? new StringContent(body, Encoding.UTF8) : new StringContent(body, Encoding.UTF8, contentType);
