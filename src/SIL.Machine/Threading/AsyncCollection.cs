...
namespace SIL.Machine.Threading
{
    ...
    public sealed class AsyncCollection<T>
    {
        ...
        public AsyncCollection(IProducerConsumerCollection<T> collection, int maxCount)
        {
            ...
            if (maxCount < collection.Count)
                throw new ArgumentException(
                    "The maximum count cannot be less than the number of elements in the collection.",
                    "maxCount"
                );
        ...
        /// </summary>
        /// <param name="collection">The collection to wrap.</param>
        public AsyncCollection(IProducerConsumerCollection<T> collection) : this(collection, int.MaxValue) { }

        /// <summary>
        /// Creates a new async-compatible producer/consumer collection with a maximum element count.
        /// </summary>
        /// <param name="maxCount">The maximum element count. This must be greater than zero.</param>
        public AsyncCollection(int maxCount) : this(null, maxCount) { }

        /// <summary>
        /// Creates a new async-compatible producer/consumer collection.
        /// </summary>
        public AsyncCollection() : this(null, int.MaxValue) { }
        ...
        private bool Full
        {
            get { return _collection.Count == _maxCount; }
        }
        ...
        internal async Task<AsyncCollection<T>> TryAddAsync(
            T item,
            CancellationToken cancellationToken,
            TaskCompletionSource abort
        )
        {
            try
            {
        ...
        public async Task AddAsync(T item, CancellationToken cancellationToken)
        {
            ...
            if (!result)
                throw new InvalidOperationException(
                    "Add failed; the producer/consumer collection has completed adding or the underlying collection refused the item."
                );
        }
        ...
        public async Task<T> TakeAsync(CancellationToken cancellationToken)
        {
            ...
            if (!ret.Success)
                throw new InvalidOperationException(
                    "Take failed; the producer/consumer collection has completed adding and is empty, or the take from the underlying collection failed."
                );
            return ret.Item;
        }
        ...
        public async Task<IReadOnlyCollection<T>> TakeAllAsync(CancellationToken cancellationToken)
        {
            try
            {
                using (await _mutex.LockAsync().ConfigureAwait(false))
                {
                    ...
                    while (_collection.TryTake(out T item))
                        result.Add(item);
                    _notFull.Notify();
                    return result;
                }
        ...
        public Task<IReadOnlyCollection<T>> TakeAllAsync()
        {
            return TakeAllAsync(CancellationToken.None);
        }
    ...
    public static class AsyncCollectionExtensions
    {
        ...
        public static async Task<AsyncCollection<T>> TryAddToAnyAsync<T>(
            this IEnumerable<AsyncCollection<T>> collections,
            T item,
            CancellationToken cancellationToken
        )
        {
            ...
            using (
                var combinedToken = CancellationTokenHelpers.Normalize(abortCancellationToken.Token, cancellationToken)
            )
            {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to abort the add operation.</param>
        /// <returns>The producer/consumer collection that received the item.</returns>
        public static AsyncCollection<T> TryAddToAny<T>(
            this IEnumerable<AsyncCollection<T>> collections,
            T item,
            CancellationToken cancellationToken
        )
        ...
        /// <param name="item">The item to add.</param>
        /// <returns>The producer/consumer collection that received the item.</returns>
        public static Task<AsyncCollection<T>> TryAddToAnyAsync<T>(
            this IEnumerable<AsyncCollection<T>> collections,
            T item
        )
        {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to abort the add operation.</param>
        /// <returns>The producer/consumer collection that received the item.</returns>
        public static async Task<AsyncCollection<T>> AddToAnyAsync<T>(
            this IEnumerable<AsyncCollection<T>> collections,
            T item,
            CancellationToken cancellationToken
        )
        {
            ...
            if (ret == null)
                throw new InvalidOperationException(
                    "Add failed; all producer/consumer collections have completed adding."
                );
            return ret;
        }
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to abort the add operation.</param>
        /// <returns>The producer/consumer collection that received the item.</returns>
        public static AsyncCollection<T> AddToAny<T>(
            this IEnumerable<AsyncCollection<T>> collections,
            T item,
            CancellationToken cancellationToken
        )
        ...
        /// <param name="item">The item to add.</param>
        /// <returns>The producer/consumer collection that received the item.</returns>
        public static Task<AsyncCollection<T>> AddToAnyAsync<T>(
            this IEnumerable<AsyncCollection<T>> collections,
            T item
        )
        {
        ...
        /// <param name="collections">The producer/consumer collections.</param>
        /// <param name="cancellationToken">A cancellation token that can be used to abort the take operation.</param>
        public static async Task<AsyncCollection<T>.TakeResult> TryTakeFromAnyAsync<T>(
            this IEnumerable<AsyncCollection<T>> collections,
            CancellationToken cancellationToken
        )
        {
        ...
        /// <param name="collections">The producer/consumer collections.</param>
        /// <param name="cancellationToken">A cancellation token that can be used to abort the take operation.</param>
        public static AsyncCollection<T>.TakeResult TryTakeFromAny<T>(
            this IEnumerable<AsyncCollection<T>> collections,
            CancellationToken cancellationToken
        )
        {
        ...
        /// </summary>
        /// <param name="collections">The producer/consumer collections.</param>
        public static Task<AsyncCollection<T>.TakeResult> TryTakeFromAnyAsync<T>(
            this IEnumerable<AsyncCollection<T>> collections
        )
        {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used to abort the take operation.</param>
        public static async Task<AsyncCollection<T>.TakeResult> TakeFromAnyAsync<T>(
            this IEnumerable<AsyncCollection<T>> collections,
            CancellationToken cancellationToken
        )
        {
            ...
            if (!ret.Success)
                throw new InvalidOperationException(
                    "Take failed; all producer/consumer collections have completed adding and are empty."
                );
            return ret;
        }
        ...
        /// <param name="collections">The array of producer/consumer collections.</param>
        /// <param name="cancellationToken">A cancellation token that can be used to abort the take operation.</param>
        public static AsyncCollection<T>.TakeResult TakeFromAny<T>(
            this IEnumerable<AsyncCollection<T>> collections,
            CancellationToken cancellationToken
        )
        {
        ...
        /// </summary>
        /// <param name="collections">The array of producer/consumer collections.</param>
        public static Task<AsyncCollection<T>.TakeResult> TakeFromAnyAsync<T>(
            this IEnumerable<AsyncCollection<T>> collections
        )
        {
