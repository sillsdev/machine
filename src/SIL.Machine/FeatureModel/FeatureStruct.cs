...
namespace SIL.Machine.FeatureModel
{
    public class FeatureStruct : FeatureValue, ICloneable<FeatureStruct>, IFreezable, IValueEquatable<FeatureStruct>
    {
        ...
        /// <summary>
        /// Global on/off switch for the bit-packed flat-vector unify fast path (RUSTIFY Phase 3).
        /// Default on; the benchmark flips it to A/B parity + timing against the original engine.
        /// </summary>
        public static bool FlatUnifyEnabled = true;
