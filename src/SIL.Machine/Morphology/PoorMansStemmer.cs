...
namespace SIL.Machine.Morphology
{
	public class PoorMansStemmer<TSeq, TItem> : PoorMansStemmingAlgorithmBase<TSeq, TItem>, IStemmer<TSeq>
	{
		...
		{
			return GetAffixes(word, AffixType.Prefix).SelectMany(prefix => GetAffixes(prefix.Item2, AffixType.Suffix), (prefix, suffix) => Tuple.Create(prefix.Item1, suffix.Item2, suffix.Item1));
		}
