...
namespace SIL.Machine.DataStructures
{
	...
	public abstract class OrderedBidirListNode<TNode> : IOrderedBidirListNode<TNode> where TNode : OrderedBidirListNode<TNode>
	{
		private OrderedBidirList<TNode> _list;
