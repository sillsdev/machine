...
namespace SIL.Machine.FiniteState
{
        ...
        where TData : IAnnotatedData<TOffset>
    {
        ...
        )
        {
            ...
            if (FstStatistics.Enabled && FstStatistics.AllocationProbe != null && scaffoldBefore != 0L)
                FstStatistics.AddScaffoldBytes(FstStatistics.AllocationProbe() - scaffoldBefore);
        ...
        private ITraversalMethod<TData, TOffset> CreateTraversalMethod()
        {
            ...
            var m = CreateTraversalMethodCore();
            FstStatistics.AddTraversalMethodBytes(FstStatistics.AllocationProbe() - before);
            return m;
        }
