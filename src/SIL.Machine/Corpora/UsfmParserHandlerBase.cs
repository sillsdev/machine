...
namespace SIL.Machine.Corpora
{
	public class UsfmParserHandlerBase : IUsfmParserHandler
	{
		...
		public virtual void Chapter(UsfmParserState state, string number, string marker, string altNumber,
			string pubNumber)
		{
		}

		public virtual void Verse(UsfmParserState state, string number, string marker, string altNumber,
			string pubNumber)
		{
		}
		...
		public virtual void Milestone(UsfmParserState state, string marker, bool startMilestone,
			IReadOnlyList<UsfmAttribute> attributes)
		{
		}
	}
