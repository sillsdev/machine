...
namespace SIL.Machine.Corpora
{
    ...
    public class UsfmParserState
    {
        ...
        /// </summary>
        public UsfmTag EmbeddedTag
        {
            get
            {
                UsfmParserElement elem = Stack.LastOrDefault(e => e.Type == UsfmElementType.Embedded);
        ...
        public bool IsVerseText
        {
            get
            {
                ...
                if (_stack.Any(e => e.Type == UsfmElementType.Sidebar || e.Type == UsfmElementType.Embedded))
                    return false;
