...
/// <summary>
/// Renders one reviewable Markdown card per row of <see cref="DataflowObligationLedger"/>, so a
/// reviewer reads one screen instead of hand-joining <c>dataflow-obligations.tsv</c>, <c>interface-witness.tsv</c>,
...
public static class EvidenceCardGenerator
{
    ...
    )
    {
        ...
        sb.AppendLine();
        sb.AppendLine("GENERATED by `hc-conformance --write-evidence-cards`. Do not hand-edit; regenerate instead.");
        sb.AppendLine();
