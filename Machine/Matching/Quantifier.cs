...
namespace SIL.Machine.Matching
{
	...
	/// </summary>
	public class Quantifier<TData, TOffset> : PatternNode<TData, TOffset>, ICloneable<Quantifier<TData, TOffset>>, IValueEquatable<Quantifier<TData, TOffset>> where TData : IAnnotatedData<TOffset>
	{
