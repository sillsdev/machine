...
namespace SIL.Machine.Matching
{
    ...
    /// </summary>
	public class Quantifier<TData, TOffset> : PatternNode<TData, TOffset>, IDeepCloneable<Quantifier<TData, TOffset>> where TData : IData<TOffset>, IDeepCloneable<TData>
    {
