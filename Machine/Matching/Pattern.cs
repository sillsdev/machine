...
{
	public class Pattern<TData, TOffset> : PatternNode<TData, TOffset>, IDeepCloneable<Pattern<TData, TOffset>>, IValueEquatable<Pattern<TData, TOffset>> where TData : IData<TOffset>, IDeepCloneable<TData>
	{
