...
{
	public class Group<TData, TOffset> : PatternNode<TData, TOffset>, IDeepCloneable<Group<TData, TOffset>>, IValueEquatable<Group<TData, TOffset>> where TData : IData<TOffset>
	{
