...
namespace SIL.Extensions
{
	public static class CollectionExtensions
	{
		...
		{
			T[] sorted = list.OrderBy(i => i, new ComparisonComparer<T>(comparison)).ToArray();
			list.Clear();
		...
		{
			T[] sorted = list.OrderBy(i => i, comparer).ToArray();
			list.Clear();
			list.AddRange(sorted);
		}
		...
		public static ObjectModel.ReadOnlyDictionary<TKey, TValue> ToReadOnlyDictionary<TKey, TValue>(this IDictionary<TKey, TValue> dictionary)
		{
