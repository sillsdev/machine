...
> sound-on-positives fast pass. Kept for its construct-by-construct regularity analysis, which is
> still accurate and still useful background — but any mention of certification, closure-as-a-gate,
> or "the FST may replace the engine" is obsolete.
