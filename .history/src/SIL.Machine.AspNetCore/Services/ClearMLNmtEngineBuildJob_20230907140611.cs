...
public class ClearMLNmtEngineBuildJob
{
    ...
    )
    {
        ...
        await sourceTrainWriter.BaseStream.DisposeAsync();
        await targetTrainWriter.BaseStream.DisposeAsync();
        return corpusSize;
    }
